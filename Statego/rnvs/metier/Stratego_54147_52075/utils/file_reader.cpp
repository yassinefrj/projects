...
void FileReader::readFilePiece(Stratego & game)
{
    ...
    std::string cheminRed = "../Stratego_54147_52075/model/red.txt";
    std::string cheminBlue = "../Stratego_54147_52075/model/blue.txt";
    std::cout << "voici le chemin pour piece Blue : " << cheminBlue <<
              std::endl;
    std::cout << "voici le chemin pour piece Red : " << cheminRed <<
              std::endl;

    std::ifstream redFile (cheminRed);
    std::ifstream blueFile (cheminBlue);
    ...
    //Add red pieces in the board game
    for (int row {6}, column{0}, cpt{0}; cpt < static_cast<int>
            (redPieces_.size()); column++, cpt ++ )
    {
        ...
        if (redPieces_[cpt] == "10")
        {
            ...
            listRedPiece_.push_back(Piece(10, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "9")
        {
            ...
            listRedPiece_.push_back(Piece(9, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "8")
        {
            ...
            listRedPiece_.push_back(Piece(8, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "7")
        {
            ...
            listRedPiece_.push_back(Piece(7, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "6")
        {
            ...
            listRedPiece_.push_back(Piece(6, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "5")
        {
            ...
            listRedPiece_.push_back(Piece(5, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "4")
        {
            ...
            listRedPiece_.push_back(Piece(4, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "3")
        {
            ...
            listRedPiece_.push_back(Piece(3, Color::RED, 1));
        ...
        else if (redPieces_[cpt] == "2")
        {
            ...
            listRedPiece_.push_back(Piece(2, Color::RED));
        ...
        else if (redPieces_[cpt] == "1")
        {
            ...
            listRedPiece_.push_back(Piece(1, Color::RED));
        ...
        else if (redPieces_[cpt] == "D")
        {
            ...
            listRedPiece_.push_back(Piece(0, Color::RED, 0));
        ...
        else if (redPieces_[cpt] == "B")
        {
            ...
            listRedPiece_.push_back(Piece(11, Color::RED, 0));


        }
        else
        {
            std::cout << "Error : the piece is not recognized : " <<
                      redPieces_[cpt] << std::endl
    ...
    //Add blue pieces in the board game
    for (int row {0}, column{0}, cpt{0}; cpt < static_cast<int>
            (bluePieces_.size()); column++, cpt ++ )
    {
        ...
        if (bluePieces_[cpt] == "10")
        {
            ...
            listBluePiece_.push_back(Piece(10, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "9")
        {
            ...
            listBluePiece_.push_back(Piece(9, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "8")
        {
            ...
            listBluePiece_.push_back(Piece(8, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "7")
        {
            ...
            listBluePiece_.push_back(Piece(7, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "6")
        {
            ...
            listBluePiece_.push_back(Piece(6, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "5")
        {
            ...
            listBluePiece_.push_back(Piece(5, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "4")
        {
            ...
            listBluePiece_.push_back(Piece(4, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "3")
        {
            ...
            listBluePiece_.push_back(Piece(3, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "2")
        {
            ...
            listBluePiece_.push_back(Piece(2, Color::BLUE));
        ...
        else if (bluePieces_[cpt] == "1")
        {
            ...
            listBluePiece_.push_back(Piece(1, Color::BLUE, 1));
        ...
        else if (bluePieces_[cpt] == "D")
        {
            ...
            listBluePiece_.push_back(Piece(0, Color::BLUE, 0));
        ...
        else if (bluePieces_[cpt] == "B")
        {
            ...
            listBluePiece_.push_back(Piece(11, Color::BLUE, 0));
            ...
            || countB != 6 ||  countDB != 1 || countD != 1 )
    {
        ...
        std::cout << "Error : miss the correct amount of pieces "  <<
                  std::endl
...
void FileReader::readFilePiece()
{

}


std::vector<std::string> FileReader::getBluePieces() const
{

}
std::vector<std::string> FileReader::getRedPieces() const
{

}

std::vector<Piece> FileReader::getListBluePiece() const
{

}
std::vector<Piece> FileReader::getListRedPiece() const
{
